...
///FOF algorithm that requires one of the particles to be dark matter for a link to occur
int FOF3dDM(Particle &a, Particle &b, Double_t *params);
///FOF algorithm that requires one of the particles to be a particular type for a link to occur
