...
#pragma omp parallel
    ...
    if (numompregions>=4 && nthreads > 1){
        ...
        if ((opt.partsearchtype==PSTALL && opt.iBaryonSearch>1) || (opt.partsearchtype==PSTALLBARYONS && opt.iBaryonSearch>1)) pfof=tree->FOFCriterionSetBasisForLinks(fofcmp,param,numgroups,minsize,iorder,0,FOFchecktype,Head,Next);
